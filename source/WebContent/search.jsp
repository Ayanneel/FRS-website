...
<body>
    <div id="header" class="header">
        <div id="navbar" class="sticky">
            <a data-toggle="modal" data-target="#loginModal">Login</a> <a href="Contacts.jsp">Contact</a>
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs" style="background-color:#fff">
                        <li class="nav-item"><a class="nav-link active" id="logintab" data-toggle="tab"
                                href="#login">Admin Login</a></li>
                        <li class="nav-item"><a class="nav-link" id="signuptab" data-toggle="tab"
                                href="#signup">Signup</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane container active" id="login">
                            <form name="loginForm" action="AdminValidationServlet" method="post">
                                <input type="text" class="form-control mb-4 mt-4" id="email-login"
